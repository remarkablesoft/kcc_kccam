...
<!--        </div>-->
        ...
        <div class="manager-content-body">
            <div class="content-title">
                ...
                <div class="btn">
                    <el-button type="st st-primary" size="small" @click="goList()">제품구분 목록 보기</el-button>
...
export default {
    ...
    data() {
        return {
	        /*트리관련 data start*/
	        applicationType : this.$amConstant.CATEGORY_TYPE.PRODUCT,
	        partOid         : "",
    ...
    methods: {
        ...
        // 수정/등록 페이지로 이동
        goEdit() {
            this.$router.push(this.localePath("/kccam/manager/productMgnt/productClassification/productClassification_edit"));
        },
