<template>
    ...
    <el-dialog title="Detail Application 추가" :visible.sync="dialogVisible" width="60rem">
            ...
            <div class="search-area">
                <div class="input-row">
                    <div class="data">
                        ...
                        <el-input size="large" placeholder="Application 명 검색" prefix-icon="el-icon-search" v-model="searchInput" clearable>
                        </el-input>
                        <!-- 검색 버튼 -->
                        <div class="btn-wrap">
                        ...
                        <table>
                            ...
                            <thead>
                                <tr class="bg-lgray">
                                    ...
                                    <th scope="col"><span>Detail Application 명</span></th>
                            ...
                            <tbody>
                                ...
                                <tr v-for="(item, i) in detailApplicationList" :key="i" class="list-item">
                                    <td>
                                    ...
                                    <td>
                                        <span v-text="item.detailApplicationName"></span>
                                    </td>
                                    <td>
