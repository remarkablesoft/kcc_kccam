...
@Profile("real2")
public class DBReal2Config implements DBConfig {
		...
		public DataSource dataSource() {
				...
				// 운영
				hikariConfig.setJdbcUrl( "jdbc:oracle:thin:@(DESCRIPTION=(ADDRESS_LIST=(LOAD_BALANCE=YES)(ADDRESS=(PROTOCOL=TCP)(HOST=70.11.10.15)(PORT=1521))(ADDRESS=(PROTOCOL=TCP)(HOST=70.11.10.16)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=KAIS))))" );
